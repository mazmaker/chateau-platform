      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
          ...
          <button
            ...
            disabled
            title="เร็วๆ นี้"
            className="w-full h-11 rounded-md bg-[#06C755] hover:bg-[#05B14B] text-white font-medium flex items-center justify-center gap-2 transition-colors opacity-60 cursor-not-allowed"
          >
            ...
            <span className="text-[10px] bg-white/20 px-1.5 py-0.5 rounded ml-1">เร็วๆ นี้</span>
          </button>
