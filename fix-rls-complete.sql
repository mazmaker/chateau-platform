...
-- ============================================================================
-- VERIFICATION QUERIES (Run these to verify the fix works)
-- ============================================================================
...
SELECT
  ...
  with_check
FROM pg_policies
WHERE tablename IN ('users', 'tenants', 'properties', 'customers', 'bookings')
ORDER BY tablename, policyname;

-- Check that SECURITY DEFINER functions exist
SELECT
...
-- ============================================================================
-- 1. No more "infinite recursion detected" errors
-- 2. Owner users can see their role in AuthContext
-- 3. Dashboard loads correctly for all user roles
-- 4. Tenant isolation is maintained (100% data separation)
-- 5. Performance: <1ms overhead from SECURITY DEFINER functions
-- ============================================================================
